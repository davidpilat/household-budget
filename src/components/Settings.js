...
export default function Settings({ settings, setSettings, setSyncing }) {
    ...
    <div>
      <div className="card">
        ...
        <div className="settings-grid">
          <div className="form-group">
            ...
            <input
              type="text" defaultValue={settings.p1_name} placeholder="e.g. Alex"
          ...
          <div className="form-group">
            ...
            <input
              type="text" defaultValue={settings.p2_name} placeholder="e.g. Jordan"
      ...
      <div className="card">
        ...
        <div className="settings-grid">
          <div className="form-group">
            ...
            <input
              type="number" defaultValue={settings.p1_income} placeholder="0" min="0"
          ...
          <div className="form-group">
            ...
            <input
              type="number" defaultValue={settings.p2_income} placeholder="0" min="0"
      ...
      <div className="card">
        ...
        <p style={{ fontSize: 13, color: 'var(--c-text2)', marginBottom: 12 }}>
          All data is shared in real-time with anyone who has the app URL. Export a CSV backup anytime.
        </p>
